...
import { ApiModule as phrwebApiModule } from './api/phr-webapi/api.module';
import { environment } from '../environments/environment';
import { CoreModule } from './components/_core/core.module';
...
@NgModule({
  imports: [
    ...
    AppComponentsModule,
    //API
    phrwebApiModule.forRoot({ rootUrl: environment.api.phrWebApi }),
    CoreModule.forRoot()
  ],
  providers: [
    JssContextService,
